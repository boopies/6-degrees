    ...
    $('.what-searched').append(
        `<h2>Results similar to <a class="final-title" href="#searchpopupsinput">${firstSearch.Name}</a>
                ...
                <div class="popup-result input">
                    ...
                    <br />
                    <br />
                    <a href='${firstSearch.wUrl}' target="blank"><svg class="readmore" width="356" height="81" viewBox="0 0 356 81" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="356" height="81" rx="35" fill="#696969"/>
                    <mask id="mask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="356" height="81">
                    <rect width="356" height="81" rx="35" fill="#696969"/>
                    </mask>
    ...
    for (let i = 0; i < finalPath.length; i++) {
        $('.slideshow-container-end').append(`<div class="myDegree my-degree-${i}">
                    ...
                    <div id="ending-popups${i}" class="overlay">
                        ...
                        <div class="read-more-final"><a href='${finalPath[i].wUrl}' target="blank">
                        <svg class="readmore" width="356" height="81" viewBox="0 0 356 81" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="356" height="81" rx="35" fill="#696969"/>
                        <mask id="mask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="356" height="81">
                        <rect width="356" height="81" rx="35" fill="#696969"/>
